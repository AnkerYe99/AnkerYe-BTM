  ...
  <el-container class="layout">
    ...
    <el-aside :width="isMobile ? '220px' : '220px'"
      ...
      <el-menu :default-active="$route.path" router @select="isMobile && (sideOpen=false)">
        ...
        <el-menu-item index="/capture"><el-icon><Document/></el-icon><span>请求捕获</span></el-menu-item>
        <el-menu-item index="/logs"><el-icon><Folder/></el-icon><span>日志管理</span></el-menu-item>
